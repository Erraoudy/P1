 ...
 */
class OndeCategories extends \TWC\OndeBundle\Entity\OndeCategories implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TWC\\OndeBundle\\Entity\\OndeCategories' . "\0" . 'id', '' . "\0" . 'TWC\\OndeBundle\\Entity\\OndeCategories' . "\0" . 'name', '' . "\0" . 'TWC\\OndeBundle\\Entity\\OndeCategories' . "\0" . 'description', '' . "\0" . 'TWC\\OndeBundle\\Entity\\OndeCategories' . "\0" . 'article'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OndeCategories $proxy) {
