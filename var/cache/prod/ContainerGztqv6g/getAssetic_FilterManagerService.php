...
return $this->services['assetic.filter_manager'] = new \Symfony\Bundle\AsseticBundle\FilterManager($this, ['cssrewrite' => 'assetic.filter.cssrewrite', 'sass' => 'assetic.filter.sass', 'compass' => 'assetic.filter.compass']);
